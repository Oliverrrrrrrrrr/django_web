    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('company_name', models.CharField(max_length=80, unique=True, verbose_name='公司名称')),
                ('screen_shot', models.ImageField(blank=True, null=True, upload_to='wenshuwang_pic', verbose_name='截图')),
            ],
            options={
                'verbose_name': '文书网',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=80, unique=True, verbose_name='用户名')),
                ('password', models.CharField(max_length=80, verbose_name='密码')),
