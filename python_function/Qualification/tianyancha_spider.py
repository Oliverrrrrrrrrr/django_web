...
def get_data(phone, password, companyname):
    ...
    wait.until(EC.presence_of_element_located(
        (By.XPATH, '//*[@id="page-root"]/div[3]/div[1]/div[3]/div/div[2]/div[2]/div/div[5]/div')))
    main_person = \
        driver.find_elements(By.XPATH, '//*[@id="page-root"]/div[3]/div[1]/div[3]/div/div[2]/div[2]/div/div[5]/div')[
            0].text
    ...
    # 第一页
    wait.until(EC.presence_of_element_located(
        (By.XPATH, '//*[@id="page-root"]/div[3]/div[1]/div[3]/div/div[2]/div[2]/div/div[16]/div/div[2]/div[3]')))
    ...
    for i in range(len(df)):
        proj = Project()
        proj.project_id = df['项目编号'][i]
        proj.project_name = df['项目名称'][i]
        proj.project_place = df['项目属地'][i]
        proj.project_type = df['项目类别'][i]
        proj.construct_company = df['建设单位'][i]
        proj.save()
